...
Sursa: https://shopilo.fr/reductions/meetic.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/meetic.fr"
STORE_NAME = "Meetic"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Meetic depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-meetic)"
    }
    try:
